...
def get_fluo_data():
    ...
    if((gv.folder=='ChRM04') | (gv.folder=='JawsM15')):
        data = loadmat('../DataForAlexandre/' + gv.folder + '/' + gv.session + 'SumFluoTraceFile' + '.mat')
        ...
        data = loadmat('../DataForAlexandre/' + gv.folder +  '/' + gv.session + '-C57-2-DualTaskAcrossDaySameROITrace' + '.mat')
        data_labels = loadmat('../DataForAlexandre/' + gv.folder + '/' + gv.session + '-C57-2-DualTask-SumFluoTraceFile' + '.mat')
